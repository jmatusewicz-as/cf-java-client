...
class CloudFoundryPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        // register tasks
        project.tasks.create('cf_target', InfoCloudFoundryTask)
        project.tasks.create('cf_login', LoginCloudFoundryTask)
        project.tasks.create('cf_logout', LogoutCloudFoundryTask)
        project.tasks.create('cf_spaces', SpacesCloudFoundryTask)
        project.tasks.create('cf_push', PushCloudFoundryTask)
        project.tasks.create('cf_delete', DeleteApplicationCloudFoundryTask)
        project.tasks.create('cf_start', StartApplicationCloudFoundryTask)
        project.tasks.create('cf_restart', RestartApplicationCloudFoundryTask)
        project.tasks.create('cf_stop', StopApplicationCloudFoundryTask)
        project.tasks.create('cf_deploy', DeployCloudFoundryTask)
        project.tasks.create('cf_undeploy', UndeployCloudFoundryTask)
        project.tasks.create('cf_swap_deployed', SwapDeployedCloudFoundryTask)
        project.tasks.create('cf_scale', ScaleCloudFoundryTask)
        project.tasks.create('cf_apps', AppsCloudFoundryTask)
        project.tasks.create('cf_app', AppCloudFoundryTask)
        project.tasks.create('cf_logs', LogsCloudFoundryTask)
        project.tasks.create('cf_services', ServicesCloudFoundryTask)
        project.tasks.create('cf_service_plans', ServiceOfferingsCloudFoundryTask)
        project.tasks.create('cf_create_service', CreateServiceCloudFoundryTask)
        project.tasks.create('cf_delete_service', DeleteServiceCloudFoundryTask)
        project.tasks.create('cf_bind', BindServiceCloudFoundryTask)
        project.tasks.create('cf_unbind', UnbindServiceCloudFoundryTask)
        project.tasks.create('cf_env', EnvCloudFoundryTask)
        project.tasks.create('cf_set_env', SetEnvCloudFoundryTask)
